 ...
 */
public class ZeichenInString {

    // Hier Methode einfügen


    public static void main(String[] args) {
        ZeichenInString tester = new ZeichenInString();
        //tester.getViertesZeichen("Mike Hansen");
        //tester.getViertesZeichen(null);
        //tester.getViertesZeichen("Elf");
    }
}
